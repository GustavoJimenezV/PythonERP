...
urlpatterns = [
    ...
    path('GraficaCompra/',views.GraficaCompra),
    ...
    path('GraficaMateriaPrima/',views.GraficaMateriaPrima),
    path('Mobiliario/',views.MenuMobiliario),
    path('GraficaMobiliario/',views.GraficaMobiliario),
    path('Pago/',views.MenuPago),
    path('Pedido/',views.MenuPedido),
    path('Permisos/',views.MenuPermiso),
    path('Producto/',views.MenuProducto),
    path('GraficaProducto/',views.GraficaProducto),
    ...
    path('GraficaVenta/',views.GraficaVenta),
]
